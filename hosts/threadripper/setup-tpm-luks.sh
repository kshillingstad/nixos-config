...
# TPM LUKS Enrollment Script for Threadripper
# Run this script after rebuilding NixOS with TPM support

set -e

LUKS_DEVICE="/dev/disk/by-uuid/065901f2-5652-4d3d-b1ba-48569f358729"

echo "=== Threadripper TPM LUKS Enrollment Setup ==="
...
echo "=== Setup Complete ==="
echo "Your Threadripper LUKS partition should now unlock automatically via TPM on boot."
