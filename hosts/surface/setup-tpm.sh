...
# TPM LUKS Enrollment Script for Surface
# Run this script after rebuilding NixOS with TPM support

set -e

LUKS_DEVICE="/dev/disk/by-uuid/a1c7c474-fe4a-4437-9ac3-1736b062f7cb"

echo "=== Surface TPM LUKS Enrollment Setup ==="
...
echo "=== Setup Complete ==="
echo "Your Surface LUKS partition should now unlock automatically via TPM on boot."
