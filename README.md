...
├── flake.nix                   # Flake configuration with all hosts
├── modules/                    # Reusable modules
│   ├── desktop.nix            # Desktop environment setup
│   ├── devtools.nix           # Development tools
│   └── kernel.nix             # Kernel configuration
└── hosts/                     # Machine-specific configurations
    ├── bfgpu/                 # Gaming desktop with NVIDIA
    │   ├── default.nix
    │   ├── hardware-configuration.nix
    │   └── nvidia.nix
    ├── laptop/                # Example laptop config
    │   └── default.nix
    └── server/                # Example server config
        └── default.nix
```
...
- **bfgpu**: Gaming desktop with NVIDIA GPU, full desktop environment
- **laptop**: Example laptop configuration with power management
- **server**: Example headless server configuration
...
- User configurations are currently duplicated - consider making this configurable if needed
