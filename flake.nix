            ...
            home-manager.nixosModules.home-manager
             {
               ...
               home-manager.extraSpecialArgs = { inherit inputs; theme = "nord"; dconfEnabled = true; };
            ...
            home-manager.nixosModules.home-manager
             {
               ...
               home-manager.extraSpecialArgs = { inherit inputs; dconfEnabled = true; };
               home-manager.users.kyle = import ./home.nix;
             }
          ];
        };
            ...
            home-manager.nixosModules.home-manager
             {
               ...
               home-manager.useUserPackages = true;
               home-manager.backupFileExtension = "backup";
               home-manager.extraSpecialArgs = { inherit inputs; theme = "nord"; dconfEnabled = false; };
               home-manager.users.kyle = import ./home.nix;
             }
          ];
        };
